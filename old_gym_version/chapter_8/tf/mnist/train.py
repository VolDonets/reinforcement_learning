...
from chapter_8.tf.mnist.model import MnistClassifier
from chapter_8.utils import mnist_dataset
import numpy as np
import sys
...
for epoch in range(1, epochs + 1):
    ...
    # !!! CODE above takes too many memory for my Nvidia 1050
    ...
    #
    # # predict tensor contains classes with the highest probability
...
loss_value = loss(y_test_one_hot, output)
