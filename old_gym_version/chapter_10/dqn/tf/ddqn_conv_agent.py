...
from chapter_10.dqn.replay_buffer import ReplayBuffer
from chapter_10.dqn.tf.q_conv_model import TfQConvNet
from chapter_10.utils import tf_2d_gather
...
class DdqnConvTfAgent:
    ...
    def soft_update(self):
        ...
        for i, (t_param, n_param) in enumerate(zip(target_params, net_params)):
            ...
            target_params[i] = blending_params
