...
from chapter_10.dqn.screen_motion import ScreenMotion
# from chapter_10.dqn.pt.ddqn_conv_agent import DdqnConvPtAgent
from chapter_10.dqn.tf.ddqn_conv_agent import DdqnConvTfAgent
from chapter_10.utils import image_rgb_to_grayscale
...
save_path = os.path.abspath(__file__)[:-9]  # remove filename
save_path += '/saved_models/dqn_tf_agent_50'
